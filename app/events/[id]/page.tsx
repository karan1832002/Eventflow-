    ...
    return (
      <div className="min-h-[50vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-500 mt-2">The event you are looking for does not exist.</p>
        </div>
      </div>
    );
  }
        ...
        <div className="space-y-10">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 text-indigo-700 text-sm font-semibold mb-5">
              <Tag size={14} /> {event.category || "General Event"}
            </div>
        ...
        <div className="relative">
          ...
          <div className="sticky top-28 bg-white rounded-[2rem] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-slate-100">
            <div className="flex justify-between items-end mb-8 border-b border-slate-100 pb-6">
              <div>
                <h2 className="text-2xl font-bold text-slate-900">Secure Seats</h2>
                <p className="text-slate-500 text-sm mt-1">Select your preferred space</p>
              </div>
